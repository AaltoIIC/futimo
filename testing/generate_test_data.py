...
NUMBER_OF_VARIABLES = 50 #Defines the number of variables in the generated test data
...
NUMBER_OF_ROWS = 200000 #How many rows are generated
SIGMA = 20
MU = 60
...
FILE_NAME = "../examples/test_data_set_200000_rows_50_variables.csv"
